...
tramo1 <- subset(datos1, select = c(5:7, 243))
...
aov.margeni
summary(aov.margeni)
tab_model(aov.margend)
tab_model(model.Htramo)


aov.margen.iS <- aov(S ~ Tramo, data = margen_i)
aov.margen.iS
summary(aov.margen.iS)
tab_model(aov.margen.iS)


aov.margen.dS <- aov(S ~ Tramo, data = margen_d)
aov.margen.dS
summary(aov.margen.dS)
tab_model(aov.margen.dS)
...
```{r}
cp_analysis1 <- subset(cp_csv[,5:16])
